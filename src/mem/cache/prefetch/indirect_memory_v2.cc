...
std::optional<Addr>
IMPv2Internals::StreamDetector::addToStreamTable(
...
bool
IMPv2Internals::StreamDetector::inStreamTable(const Addr IP,
...
void
IMPv2Internals::IndirectTable::newIndex(const Addr IP, const int64_t index)
{
    // Get the relevant entry
...
void
IMPv2Internals::IndirectTable::updateConfidence(const Addr addr)
{
...
void
IMPv2Internals::IndirectTable::setBaseAddrAndShift(
...
std::optional<Addr>
IMPv2Internals::IndirectTable::getPrefetchCandidate(const Addr IP,
...
std::optional<Addr>
IMPv2Internals::IndirectTable::getIndirectPrefetchDistance(const Addr IP) const
{
    // Get the relevant entry
    const Addr indirect_table_idx = IP % indirect_table_size;
    if (indirect_table.find(indirect_table_idx)
...
void
IMPv2Internals::IndirectPatternDetector::setIndex(const Addr IP,
                const int64_t index)
{
...
void
IMPv2Internals::IndirectPatternDetector::discardIndex()
{
...
IMPv2Internals::IndirectPatternDetector::recordMiss(const Addr miss_addr)
{
...
void
IMP::updateConfidence(const Addr addr)
{
    prefetch_table.getIndirectTable().updateConfidence(addr);
}

std::vector<Addr>
IMP::updateStreamDetectorState(const PrefetchInfo& pfi)
{
...
void
IMP::handleIndexAccess(const PrefetchInfo& pfi)
{
    /*
...
void
IMP::handleIndirectAccess(const PrefetchInfo& pfi)
{
...
std::vector<Addr>
IMP::learnPattern(const PrefetchInfo& pfi)
{
    /*
...
std::optional<Addr>
IMP::generateIndirectPrefetchCandidate(const PrefetchInfo& pfi)
{
    /*
...
void
IMP::calculatePrefetch(const PrefetchInfo &pfi,
...
void
IMP::notifyFill(const CacheAccessProbeArg &arg)
{
